...
function createPanoViewer(e) {
    ...
    function lt() {
        ...
        if (s == p) {
            function T() {
                ...
                if (t[Y]) {
                    ...
                    if (typeof e == "object") {
                        ...
                        if (n) {
                            i = v,
                            t[O] && (s = t[O]["application/x-shockwave-flash"], s && (s.enabledPlugin || (i = p)));
                            if (i) {
                                o = n[R](" ");
                                for (u = 0; u < o[x]; ++u) {
                                    a = parseFloat(o[u]);
            ...
            if (e.isDevice("iphone|ipad|ipod")) a = f = v;
                ...
                l && (g > 0 && g < 4 && (l = p), m > 3 && m < 18 && g > 1 && (c = l = p), c || (h[d](Q) < 0 && m > 3 && g < 1 && (l = p), y > 9 && y < 20 && (l = p)));
                if (l || c) {
                    a = v,
    ...
    e[D] || (e[D] = []),
    e[I] || (e[I] = E),
    e[$] ? e[k] = e[$] : (c = "./", h = e.swf[tt]("/"), h >= 0 && (c = e.swf[U](0, h + 1)), e[$] = c),
    ...
    e.embed = function(s) {
        ...
        if (!e[w]) e[S]("No Embedding Target");
            ...
            _ = a,
            c == q ? _ = p: ut(c, st) && (h = p),
            ut(c, B) ? (o = h = p, a = _ = v) : _ && (c == "whenpossible" || ut(c, "prefer") || ut(c, it) && f) && (h = p);
            if (h && o) {
                function Z(e) {
                    function S(e) {
                        function a() {
                    ...
                    for (;;) {
                        s = n[T](h);
                        if (!s) break;
                        h += String.fromCharCode(48 + Math.floor(9 * Math.random())),
                        e.id = h
                    }
                    e[b] && (c[b] = e[b]),
                    e[N] && (c[N] = e[N]),
                    ...
                    for (i in l) f != "" && (f += "&"),
                    f += encodeURIComponent(i) + "=" + encodeURIComponent(l[i]);
                    c.flashvars = f,
                    e[k] && (c.base = e[k]),
                    o = "",
                    u = ' id="' + h + '" width="' + e.width + '" height="' + e.height + '" style="outline:none;" ',
                    a = "_krpcb_" + h,
                    !e[I] || (r[a] = function() {
                        try {
                            delete r[a]
                ...
                u >= 11.4 && (H = v, ot(t.platform)[d](Q) >= 0 && ot(t.vendor)[d]("apple") >= 0 && (R = i[d]("webkit/"), R > 0 && (R = parseFloat(i[U](R + 7)), !isNaN(R) && R > 0 && R < 534 && (H = p))), H && e[b] == E && !e[D][b] && (e[b] = "direct")),
                Z(e)
            } else if (_ && a) {
                function nt(t) {
                    function h(e, t, r) {
                        ...
                        s && (s = s[0]),
                        s || (s = n.body),
                        s ? (i = n[A]("script"), i.type = "text/javascript", i.async = v, i.onload = t, i[S] = r, i.src = f + e, s.appendChild(i)) : r()
                    }
                    function d() {
...
embedPanoViewer = embedpano,
createkrpanoSWFviewer = createswf;