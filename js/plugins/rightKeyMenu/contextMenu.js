...
//              }],
        ...
        renderMenu: function() {
            ...
            if (! (e(n).length > 0)) {
                ...
                function(t, n) {
                    n.icon ? i += '<li class="ui-context-menu-item"><a href="javascript:void(0);"><img class="icon" src="' + n.icon + '" /><span>' + n.text + "</span></a></li>": i += '<li class="ui-context-menu-item"><a href="javascript:void(0);"><span>' + n.text + "</span></a></li>"
                }),
                i += "</ul>",
        ...
        menuItemClick: function(t) {
            ...
            n.opts.menu[e].callback && "function" == typeof n.opts.menu[e].callback && n.opts.menu[e].callback(this)    //TODO  2018年0317 李长明修改 增加回调传参 默认为callback()
        },
		...
		removeSelf : function() {
			var t = this;
			this.ele.off("click");
			e("#uiContextMenu_" + this.random).off('click', ".ul-context-menu").remove();
		}
    },
